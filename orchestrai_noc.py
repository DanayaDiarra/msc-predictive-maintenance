...
""", language="toml")
    ...
    with s_guide:
        ...
        for _num,_title,_color,_content in [
            ("1","📡 BTS STATIONS (25 Sites)","#58a6ff","<strong>Sensors:</strong> Temperature, Vibration, Power, RF Metrics<br><strong>Update Interval:</strong> Real-time telemetry every 10 seconds<br><strong>Coverage:</strong> Mali (12 sites), Senegal (11 sites), Guinea & Burkina Faso (2 sites)"),
