...
STATIONS = [
    ...
    dict(id="ML_SGU_24",  urgency="Monitor",  sub="power_subsystem",       sla=168,
         ...
         a2="Plan capacitor replacement if ripple >4V", a2t="AUTO", a1tool="open_ticket",
    ...
    dict(id="SN_ZIG_09",  urgency="Monitor",  sub="backhaul_connectivity", sla=168,
         cl=85.1, ch=117.3, conf=0.605, gr=1.0, hal=0.0, cost=0, auto_n=1, to_n=1, hum_n=0, cov=0.60,
         doc="MAN-BKH-001", subset="FD004", cycles=108,
         hyp="Backhaul throughput trending down — Ziguinchor fiber path",
         fc="Fibre optic splice point", mech="Splice loss 0.8dB causing throughput drop",
         alm="BKH-002 (throughput low) if <850 Mbps",
         a1="Schedule OTDR test within 14d", a1t="AUTO", a1tool="open_ticket",
         a2="Monitor throughput trend", a2t="AUTO", a2tool="open_ticket",
         base_rul=101.2, top_feat="latency_slope", top_imp=0.0567,
         degrade=0.03, sensor_lbl="Throughput", sensor_nom=892.0, sensor_unit="Mbps", sensor_dir="low"),
