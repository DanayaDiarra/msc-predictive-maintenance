...
def seed_hr():
    ...
    engineers = [
        ...
        ("ENG005","Aminata Bah",      "a.bah@noc.sn",       "+221 78 901 3364","Thiès",        "Senegal",      '["baseband_processing","rf_antenna"]',       "baseband_processing",   "Senior",0,"Night",   "2021-04-18","Field Operations","MGR002",29,4.1),
        ("ENG006","Ousmane Diarra",   "o.diarra@noc.ml",    "+223 66 543 7821","Sikasso",      "Mali",         '["power_subsystem","thermal_management"]',   "power_subsystem",       "Senior",1,"Day",     "2019-09-12","Field Operations","MGR001",44,3.4),
        ("ENG007","Mariama Sylla",    "m.sylla@noc.sn",     "+221 77 612 9034","Saint-Louis",  "Senegal",      '["rf_antenna","baseband_processing"]',       "rf_antenna",            "Senior",0,"Night",   "2020-06-20","Field Operations","MGR002",36,3.9),
        ("ENG008","Sekou Keita",      "s.keita@noc.ml",     "+223 70 234 8765","Kayes",        "Mali",         '["backhaul_connectivity","baseband_processing"]', "backhaul_connectivity", "Senior",1,"Day", "2018-11-08","Field Operations","MGR002",58,2.7),
        # Mid-Level Engineers
        ("ENG009","Oumar Ndiaye",     "o.ndiaye@noc.sn",    "+221 77 654 0915","Kolda",        "Senegal",      '["power_subsystem"]',                       "power_subsystem",       "Mid",  1,"Day",     "2022-09-01","Field Operations","MGR001",18,3.9),
        ("ENG010","Kadiatou Barry",   "k.barry@noc.ml",     "+223 66 412 7780","Mopti",        "Mali",         '["thermal_management"]',                    "thermal_management",    "Mid",  1,"Day",     "2022-02-14","Field Operations","MGR001",22,4.2),
        ("ENG011","Seydou Coulibaly", "s.coulibaly@noc.ml", "+223 70 823 5591","Ségou",        "Mali",         '["rf_antenna","thermal_management"]',        "rf_antenna",            "Mid",  0,"Night",   "2023-05-20","Field Operations","MGR002",11,4.5),
        ("ENG012","Mariam Keita",     "m.keita@noc.sn",     "+221 76 234 6102","Thiès",        "Senegal",      '["backhaul_connectivity"]',                 "backhaul_connectivity", "Mid",  1,"Day",     "2022-11-30","Field Operations","MGR002",16,3.7),
        ("ENG013","Lamine Touré",     "l.toure@noc.ml",     "+223 65 789 2341","Gao",          "Mali",         '["power_subsystem","rf_antenna"]',           "power_subsystem",       "Mid",  1,"Day",     "2022-04-18","Field Operations","MGR001",21,4.0),
        ("ENG014","Binta Cissé",      "b.cisse@noc.sn",     "+221 76 890 3452","Ziguinchor",   "Senegal",      '["thermal_management","backhaul_connectivity"]', "thermal_management","Mid",  0,"Night",   "2023-01-25","Field Operations","MGR001",14,4.3),
        ("ENG015","Moussa Sanogo",    "m.sanogo@noc.ml",    "+223 79 456 1230","Bamako",       "Mali",         '["baseband_processing","power_subsystem"]',  "baseband_processing",   "Mid",  1,"Day",     "2022-08-15","Field Operations","MGR002",19,3.8),
        ("ENG016","Aïcha Diop",       "a.diop@noc.sn",      "+221 78 123 5678","Dakar",        "Senegal",      '["rf_antenna"]',                            "rf_antenna",            "Mid",  0,"Night",   "2023-03-10","Field Operations","MGR002",12,4.6),
        ("ENG017","Bakary Konaté",    "b.konate@noc.ml",    "+223 66 678 9012","Sikasso",      "Mali",         '["backhaul_connectivity"]',                 "backhaul_connectivity", "Mid",  1,"Day",     "2022-12-05","Field Operations","MGR002",17,4.1),
        ("ENG018","Fatoumata Camara", "f.camara@noc.sn",    "+221 77 234 7890","Saint-Louis",  "Senegal",      '["power_subsystem","thermal_management"]',   "power_subsystem",       "Mid",  0,"Night",   "2023-02-28","Field Operations","MGR001",13,4.4),
        # Junior Engineers
        ("ENG019","Boubacar Diop",    "b.diop@noc.sn",      "+221 78 567 3243","Dakar",        "Senegal",      '["baseband_processing","power_subsystem"]',  "baseband_processing",   "Junior",1,"Day",   "2024-01-15","Field Operations","MGR001",8, 5.1),
        ("ENG020","Rokhaya Fall",     "r.fall@noc.sn",      "+221 77 890 1154","Thiès",        "Senegal",      '["power_subsystem"]',                       "power_subsystem",       "Junior",0,"Night",  "2024-03-01","Field Operations","MGR001",5, 5.8),
        ("ENG021","Alpha Baldé",      "a.balde@noc.ml",     "+223 63 345 9865","Bamako",       "Mali",         '["rf_antenna"]',                            "rf_antenna",            "Junior",1,"Day",    "2024-06-10","Field Operations","MGR002",4, 6.2),
        ("ENG022","Saliou Sow",       "s.sow@noc.ml",       "+223 70 912 3456","Kayes",        "Mali",         '["thermal_management"]',                    "thermal_management",    "Junior",1,"Day",    "2024-04-20","Field Operations","MGR001",6, 5.5),
        ("ENG023","Khady Gueye",      "k.gueye@noc.sn",     "+221 76 456 7823","Kolda",        "Senegal",      '["backhaul_connectivity"]',                 "backhaul_connectivity", "Junior",0,"Night",  "2024-05-15","Field Operations","MGR002",3, 6.8),
        ("ENG024","Modibo Sissoko",   "m.sissoko@noc.ml",   "+223 65 234 6789","Mopti",        "Mali",         '["baseband_processing"]',                   "baseband_processing",   "Junior",1,"Day",    "2024-07-01","Field Operations","MGR002",2, 7.1),
        ("ENG025","Ndeye Ndiaye",     "n.ndiaye@noc.sn",    "+221 77 789 4561","Ziguinchor",   "Senegal",      '["power_subsystem"]',                       "power_subsystem",       "Junior",0,"Night",  "2024-08-10","Field Operations","MGR001",1, 7.5),
        ("ENG026","Drissa Coulibaly", "d.coulibaly@noc.ml", "+223 66 567 8902","Ségou",        "Mali",         '["rf_antenna"]',                            "rf_antenna",            "Junior",1,"Day",    "2024-09-05","Field Operations","MGR002",2, 6.9),
        ("ENG027","Astou Ba",         "a.ba@noc.sn",        "+221 78 345 6782","Dakar",        "Senegal",      '["thermal_management"]',                    "thermal_management",    "Junior",0,"Night",  "2024-10-01","Field Operations","MGR001",1, 7.3),
        # Managers
